...
void main() async {
  ...
  final screensDir = Directory('${libDir.path}/screens');
  if (screensDir.existsSync()) {
    screensDir.renameSync('${libDir.path}/views');
    print('Renamed screens/ -> views/');
  }

  final serviceDir = Directory('${libDir.path}/service');
  if (serviceDir.existsSync()) {
    serviceDir.renameSync('${libDir.path}/services');
    print('Renamed service/ -> services/');
  }

  final providersDir = Directory('${libDir.path}/providers');
  if (providersDir.existsSync()) {
    providersDir.renameSync('${libDir.path}/viewmodels');
    print('Renamed providers/ -> viewmodels/');
  }
